...
from einstein_layers import run_einstein_layers  # 🔗 NEW IMPORT
...
# Step 5: Run relativistic Einstein layers
...
print("✅ SYNRAXIS engine complete. Output saved to forecast/synraxis_output.json")
